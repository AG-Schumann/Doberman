...
class iseries2Command(object):

    """
    Class that holds the newport iseries2 i3200 controller commands
    """
    def __init__(self):
        pass
    ...
    def communicate(self, message): 
        """
        Note that this is a test function. iseries2Serial has its own communicate fuction
