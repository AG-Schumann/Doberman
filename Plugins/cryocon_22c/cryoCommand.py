...
class cryoCommand(object):
    """
    Class that holds the cryo con controller 22c commands
    """
    ...
    def SetInpChannel(self,channel):
        """
        Set the input channel of the controller for the program: A or B. Program uses this as standard in all commands iff no input channel specified. 
        """
        if not str(channel) in ['A','B']:
            return -1
